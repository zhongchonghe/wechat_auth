package com.example.wechat_auth;
...
/** WechatAuthPlugin */
public class WechatAuthPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
...
//                  CODE=rsp.code;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "wechat_auth");
